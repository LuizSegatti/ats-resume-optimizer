# === ATS Resume Optimizer v1.4 – GPT Enhanced + Tracker ===
...
st.title("📄 ATS Resume Optimizer v1.4 – GPT Enhanced + Tracker")
...
if analyze_btn and uploaded_resume and uploaded_jd and api_key:
    ...
    if not ext_resume.endswith(".docx") or not ext_jd.endswith(".docx"):
        ...
        with st.spinner("🧠 Extracting and analyzing your documents..."):
            ...
            try:
                gpt_result = json.loads(raw_output)
            except json.JSONDecodeError as e:
                st.error("❌ GPT output was not valid JSON. Try again or adjust the prompt.")
                st.stop()
